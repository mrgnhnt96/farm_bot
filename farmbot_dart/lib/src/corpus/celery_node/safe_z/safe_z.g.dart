...
_$_DefaultSafeZ _$_$_DefaultSafeZFromJson(Map json) {
  return _$_DefaultSafeZ(
    ...
    args: SafeZArgs.fromJson(Map<String, dynamic>.from(json['args'] as Map)),
  );
}
...
_$_SafeZArgs _$_$_SafeZArgsFromJson(Map json) {
  return _$_SafeZArgs(
    axis: _$enumDecode(_$AllowedAxisEnumMap, json['axis']),
  );
}

Map<String, dynamic> _$_$_SafeZArgsToJson(_$_SafeZArgs instance) =>
    <String, dynamic>{
