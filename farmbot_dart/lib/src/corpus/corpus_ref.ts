...
export type ALLOWED_ASSERTION_TYPES =
  | "abort"
  | "abort_recover"
  | "continue"
  | "recover";
...
export type ALLOWED_MESSAGE_TYPES =
  | "assertion"
  | "busy"
  | "debug"
  | "error"
...
export type ALLOWED_SPECIAL_VALUE =
  | "current_location"
  | "safe_height"
  | "soil_height";
...
export type InternalRegimenBodyItem =
  | ParameterApplication
  | ParameterDeclaration
  | VariableDeclaration;
/** internal_regimen
...
export type RpcRequestBodyItem =
  | If
  | Assertion
  | Calibrate
  | ChangeOwnership
...
export type ScopeDeclarationBodyItem =
  | ParameterDeclaration
  | VariableDeclaration;
/** scope_declaration
